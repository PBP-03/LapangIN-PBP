...
class Command(BaseCommand):
    ...
    def create_venues(self):
        ...
        venues_data = [
            ...
            # More Futsal venues
            {
                'name': 'Futsal Pro Surabaya',
                'owner': 'mitra_futsal_jakarta',
                'address': 'Jl. HR Muhammad No. 88, Surabaya, Jawa Timur',
                'location_url': 'https://maps.google.com/futsal-pro-surabaya',
                'contact': '+62812-1111-7777',
                'description': 'Lapangan futsal dengan rumput sintetis terbaik. Dilengkapi dengan kantin dan musholla.',
                'number_of_courts': 2,
            },
            {
                'name': 'Sky Futsal Medan',
                'owner': 'mitra_voli_medan',
                'address': 'Jl. Sisingamangaraja No. 150, Medan, Sumatera Utara',
                'location_url': 'https://maps.google.com/sky-futsal-medan',
                'contact': '+62812-5555-8888',
                'description': 'Futsal center di lantai 3 dengan pemandangan kota. AC, sound system, dan LED scoreboard.',
                'number_of_courts': 3,
            },
            {
                'name': 'Grand Futsal Bali',
                'owner': 'mitra_futsal_jakarta',
                'address': 'Jl. Sunset Road No. 88, Denpasar, Bali',
                'location_url': 'https://maps.google.com/grand-futsal-bali',
                'contact': '+62812-1111-9999',
                'description': 'Futsal arena terbesar di Bali dengan 5 lapangan standar FIFA. Parkir luas dan cafe.',
                'number_of_courts': 5,
            },
            # More Badminton venues
            {
                'name': 'Prima Badminton Jakarta',
                'owner': 'mitra_badminton_bandung',
                'address': 'Jl. Fatmawati No. 200, Jakarta Selatan, DKI Jakarta',
                'location_url': 'https://maps.google.com/prima-badminton',
                'contact': '+62812-2222-7777',
                'description': 'Gedung badminton dengan 10 lapangan indoor. Karpet BWF approved dan AC central.',
                'number_of_courts': 10,
            },
            {
                'name': 'Eagle Badminton Surabaya',
                'owner': 'mitra_basket_surabaya',
                'address': 'Jl. Basuki Rahmat No. 99, Surabaya, Jawa Timur',
                'location_url': 'https://maps.google.com/eagle-badminton',
                'contact': '+62812-3333-8888',
                'description': 'Badminton center dengan fasilitas lengkap. Pro shop, locker room, dan waiting area nyaman.',
                'number_of_courts': 6,
            },
            {
                'name': 'Star Badminton Yogyakarta',
                'owner': 'mitra_tenis_yogya',
                'address': 'Jl. Solo No. 155, Yogyakarta, DIY',
                'location_url': 'https://maps.google.com/star-badminton',
                'contact': '+62812-4444-9999',
                'description': 'Lapangan badminton keluarga dengan harga terjangkau. 4 lapangan indoor berkualitas.',
                'number_of_courts': 4,
            },
            # More Basketball venues
            {
                'name': 'Hoops Basketball Jakarta',
                'owner': 'mitra_futsal_jakarta',
                'address': 'Jl. Rasuna Said No. 300, Jakarta Selatan, DKI Jakarta',
                'location_url': 'https://maps.google.com/hoops-basketball',
                'contact': '+62812-1111-6666',
                'description': 'Indoor basketball court dengan lantai kayu premium. Dilengkapi gym dan locker room.',
                'number_of_courts': 2,
            },
            {
                'name': 'Dunk Basketball Bandung',
                'owner': 'mitra_badminton_bandung',
                'address': 'Jl. Cihampelas No. 177, Bandung, Jawa Barat',
                'location_url': 'https://maps.google.com/dunk-basketball',
                'contact': '+62812-2222-5555',
                'description': 'Outdoor basketball court dengan floodlight. Cocok untuk streetball dan tournament.',
                'number_of_courts': 1,
            },
            {
                'name': 'Metro Basketball Center',
                'owner': 'mitra_voli_medan',
                'address': 'Jl. Imam Bonjol No. 88, Medan, Sumatera Utara',
                'location_url': 'https://maps.google.com/metro-basketball',
                'contact': '+62812-5555-6666',
                'description': 'Kompleks basket indoor dan outdoor. Fasilitas tribune untuk 300 penonton.',
                'number_of_courts': 3,
            },
            # More Tennis venues
            {
                'name': 'Ace Tennis Jakarta',
                'owner': 'mitra_futsal_jakarta',
                'address': 'Jl. Senayan No. 45, Jakarta Pusat, DKI Jakarta',
                'location_url': 'https://maps.google.com/ace-tennis',
                'contact': '+62812-1111-4444',
                'description': 'Klub tenis premium dengan 8 lapangan hard court. Pelatih profesional tersedia.',
                'number_of_courts': 8,
            },
            {
                'name': 'Court Tennis Surabaya',
                'owner': 'mitra_basket_surabaya',
                'address': 'Jl. Diponegoro No. 200, Surabaya, Jawa Timur',
                'location_url': 'https://maps.google.com/court-tennis',
                'contact': '+62812-3333-5555',
                'description': 'Lapangan tenis dengan surface clay dan hard court. Club house dengan cafe.',
                'number_of_courts': 4,
            },
            # More Volleyball venues  
            {
                'name': 'Spike Volleyball Jakarta',
                'owner': 'mitra_futsal_jakarta',
                'address': 'Jl. Kuningan No. 88, Jakarta Selatan, DKI Jakarta',
                'location_url': 'https://maps.google.com/spike-volleyball',
                'contact': '+62812-1111-3333',
                'description': 'Arena voli indoor dengan lantai khusus dan net tournament grade. AC dan sound system.',
                'number_of_courts': 2,
            },
            {
                'name': 'Beach Volleyball Bali',
                'owner': 'mitra_voli_medan',
                'address': 'Jl. Pantai Kuta No. 99, Denpasar, Bali',
                'location_url': 'https://maps.google.com/beach-volleyball',
                'contact': '+62812-5555-4444',
                'description': 'Lapangan voli pantai dengan pasir impor. Suasana tropis dan sunset view.',
                'number_of_courts': 3,
            },
            # Mixed Sports Complex
            {
                'name': 'Multi Sports Arena Bandung',
                'owner': 'mitra_badminton_bandung',
                'address': 'Jl. Asia Afrika No. 300, Bandung, Jawa Barat',
                'location_url': 'https://maps.google.com/multi-sports-bandung',
                'contact': '+62812-2222-4444',
                'description': 'Kompleks olahraga dengan berbagai jenis lapangan. Futsal, badminton, dan basket dalam satu tempat.',
                'number_of_courts': 10,
            },
            {
                'name': 'Sports Hub Surabaya',
                'owner': 'mitra_basket_surabaya',
                'address': 'Jl. Mayjen Sungkono No. 188, Surabaya, Jawa Timur',
                'location_url': 'https://maps.google.com/sports-hub-surabaya',
                'contact': '+62812-3333-6666',
                'description': 'Hub olahraga modern dengan lapangan futsal, basket, dan tenis. Dilengkapi fitness center.',
                'number_of_courts': 8,
            },
            {
                'name': 'Arena Sports Yogyakarta',
                'owner': 'mitra_tenis_yogya',
                'address': 'Jl. Kaliurang No. 250, Yogyakarta, DIY',
                'location_url': 'https://maps.google.com/arena-sports-yogya',
                'contact': '+62812-4444-7777',
                'description': 'Kompleks olahraga keluarga dengan berbagai fasilitas. Kolam renang, cafe, dan kids playground.',
                'number_of_courts': 6,
            },
            {
                'name': 'Champion Sports Complex',
                'owner': 'mitra_futsal_jakarta',
                'address': 'Jl. TB Simatupang No. 400, Jakarta Selatan, DKI Jakarta',
                'location_url': 'https://maps.google.com/champion-sports',
                'contact': '+62812-1111-8888',
                'description': 'Kompleks olahraga terlengkap di Jakarta Selatan. Berbagai cabang olahraga dalam satu lokasi.',
                'number_of_courts': 15,
            },
        ]
